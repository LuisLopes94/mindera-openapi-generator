...
public class Swift6ClientCodegen extends org.openapitools.codegen.languages.Swift6ClientCodegen {

    public Swift6ClientCodegen() {
        super();

        embeddedTemplateDir = templateDir = "mindera-swift6";
